            ...
            try {
                ...
                if ($stmt->fetch()) {
                    ...
                    $ins = db()->prepare("INSERT INTO usuarios (nome, email, senha, confirmado, token_confirmacao, token_expira) 
                                           VALUES (:nome, :email, :senha, 0, :token, :expira)");
                    $ins->execute([
                        ':nome'    => $nome_digitado,
                    ...
                    if (enviar_email($email_digitado, $assunto, $corpo_html)) {
                        ...
                        // Exceção ou falha no envio de e-mail, mas o usuário foi gravado. Podemos excluir para que tente novamente.
...
<div class="login-container">
    <div class="login-card">
        ...
        <h4 class="login-title">Crie sua Conta SaaS</h4>
        ...
        <form action="cadastro.php" method="POST" autocomplete="off" onsubmit="return validarEnvio(event)">
            <div class="mb-2">
                ...
                <div class="input-group-custom">
                    <input type="text" id="nome" name="nome" 
                           class="form-control-custom" placeholder="Como você quer ser chamado..."
                           value="<?= htmlspecialchars($nome_digitado) ?>" required autofocus>
            ...
            <div class="mb-2">
                ...
                <div class="input-group-custom">
                    <input type="password" id="senha" name="senha" 
                           class="form-control-custom" placeholder="Mínimo 8 caracteres..." 
                           required onkeyup="analisarSenha(this.value)">
                    <i class="bi bi-lock input-icon"></i>
                    <button type="button" class="btn-toggle-pass" onclick="toggleSenha('senha', this)" title="Exibir/ocultar senha">
                        <i class="bi bi-eye"></i>
                    </button>
                </div>
            </div>
            ...
            <div class="mb-2">
                ...
                <div class="input-group-custom">
                    <input type="password" id="confirmar_senha" name="confirmar_senha" 
                           class="form-control-custom" placeholder="Repita a senha criada..." required>
                    <i class="bi bi-lock-fill input-icon"></i>
                    <button type="button" class="btn-toggle-pass" onclick="toggleSenha('confirmar_senha', this)" title="Exibir/ocultar senha">
                        <i class="bi bi-eye"></i>
                    </button>
                </div>
            </div>
            ...
            <div class="password-strength-box">
                ...
                <div class="strength-rule" id="rule-upper"><i class="bi bi-circle"></i> Pelo menos uma letra maiúscula (A-Z)</div>
                <div class="strength-rule" id="rule-lower"><i class="bi bi-circle"></i> Pelo menos uma letra minúscula (a-z)</div>
                <div class="strength-rule" id="rule-num"><i class="bi bi-circle"></i> Pelo menos um número (0-9)</div>
                <div class="strength-rule" id="rule-special"><i class="bi bi-circle"></i> Pelo menos um caractere especial (!@#$...)</div>
            </div>
